...
/*
	#######################
	@ - Hex value convert into binary.
	  //
	  + 0x40 = 0b0100,0000 -> configure bit-6 -> for auto-increment address
	  + 0x80 = 0b1000,0000 -> configure bit-7 -> read/write mode
*/
...
/*
   #######################
   3rd Step
   @ - Goal: This function read data from ADXL345 sensor registers usually
       X,Y,Z (acceleration value).
*/
void adxl_read(uint8_t address, uint8_t * rxdata)
{
	  ...
	  */
	  ...
	  /*
	   *  @2 - This will pull CS (chip select) = LOW
	  ...
	  /*
	   *  @2 - Read 6 bytes (data from sensor)
	  ...
	  /*
	   *  @2 - Pull CS high → “I’m done talking to you.”
...
/*
   ...
   2nd Step
   @ -
     + Before we can read data (acceleration) from ADXL345 sensor,
       we must write some settings inside sensor's register to make
       sensor activate.
...
void adxl_write (uint8_t address, uint8_t value)
{
  ...
  */
  ...
  /*
     --------------------------
     @2 - Enable multi-byte, place address into buffer
        //
		+ Eg
  ...
  */
  ...
  /*
     -----------------------
     @2 - Pull cs line low to enable slave
  */
  cs_enable();

  /*
     -----------------------
     @2 - Transmit ADXL register's address and value for register into
          ADXL using SPI.
  */
  ...
  /*
     ------------------------
     @2 - Pull cs line high to disable slave
  */
  cs_disable();
...
/*
   ####################
   1st Step
   @ - Goals: Activate ADXL so the sensor can start measure acceleration
*/
void adxl_init (void)
{
	/*
	...
	*/
	...
	/*
	   --------------------
	   @2 - Goals: Set data format range to operate at ±4g
          //
       @3 - From 'adxl345.h' file
	  	  + DATA_FORMAT_R = 0x31
	      + FOUR_G = 0x01
	*/
	...
	/*
	   --------------------
	   @2 - Goal: Reset all bits
	*/
	adxl_write (POWER_CTL_R, RESET);

	/*
	   ----------------------
	   @2 - Goal: Configure power control measure bit
	*/
